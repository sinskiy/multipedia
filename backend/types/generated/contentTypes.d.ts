...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    shared: Schema.Attribute.Relation<
      'manyToMany',
...
export interface ApiCommentComment extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    markdown: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    incoming: Schema.Attribute.Relation<
      'manyToMany',
      'plugin::users-permissions.user'
    >;
    likes: Schema.Attribute.Relation<'oneToMany', 'api::like.like'>;
    ...
    > &
      Schema.Attribute.Private;
    outcoming: Schema.Attribute.Relation<
      'manyToMany',
      'plugin::users-permissions.user'
    >;
    password: Schema.Attribute.Password &
    ...
    role: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    shared_articles: Schema.Attribute.Relation<
      'manyToMany',
      'api::article.article'
    >;
    updatedAt: Schema.Attribute.DateTime;
